...
class TestCameraAngles extends Fixtured {
    ...
    void testCameraAngles1() {
        {
            ...
            Translation2d testTranslation1 = PoseEstimationHelper.cameraRotationToRobotRelative(e, new Rotation3d()).get();
            Translation2d testTranslation2 = PoseEstimationHelper.cameraRotationToRobotRelative(e,
                    new Rotation3d(0, Math.toRadians(25), Math.toRadians(-10))).get();
    ...
    void testCameraAngles5() {
            ...
            Translation2d testTranslation2 = PoseEstimationHelper.cameraRotationToRobotRelative(d, new Rotation3d()).get();
    ...
    void testCameraAngles6() {
        {
            ...
            Translation2d testTranslation1 = PoseEstimationHelper.cameraRotationToRobotRelative(e, new Rotation3d(0,0, Math.toRadians(45))).get();
            assertEquals(1, testTranslation1.getX(), 0.0001);
            assertEquals(-1, testTranslation1.getY(), 0.0001);
            Transform3d dTransform3d = new Transform3d(0, 0, 1, new Rotation3d(Math.PI/2, Math.toRadians(45), 0));
            Translation2d testTranslation2 = PoseEstimationHelper.cameraRotationToRobotRelative(dTransform3d, new Rotation3d(0,Math.toRadians(45),0)).get();
            assertEquals(-1, testTranslation2.getY(), 0.0001);
