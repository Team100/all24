...
public class NotePickerTest {
    ...
    void testObviousPick() {
        ...
        Translation2d expected2 = NotePicker
                .closestNote(Optional.of(e), new Pose2d(new Translation2d(10, 10), new Rotation2d())).get();
    ...
    void testLessObviousPick() {
        ...
        Translation2d expected = NotePicker
                .closestNote(Optional.of(e), new Pose2d(new Translation2d(0.6, 0.6), new Rotation2d())).get();
