...
class SlipperyTireUtilTest {
    ...
    void testMotionless() {
        ...
        check(0, 0, position0[0]);
        check(0, 0, position0[1]);
        check(0, 0, position0[2]);
        check(0, 0, position0[3]);
        ...
        check(0, 0, position1[0]);
        check(0, 0, position1[1]);
        check(0, 0, position1[2]);
        check(0, 0, position1[3]);
    ...
    void testLinear() {
        ...
        check(0.02, 0, position1[0]);
        check(0.02, 0, position1[1]);
        check(0.02, 0, position1[2]);
        check(0.02, 0, position1[3]);
    ...
    void testSpin() {
        ...
        check(0, 135, position0[0]);
        check(0, 45, position0[1]);
        check(0, -135, position0[2]);
        check(0, -45, position0[3]);
        ...
        check(0.014, 135, position1[0]);
        check(0.014, 45, position1[1]);
        check(0.014, -135, position1[2]);
        check(0.014, -45, position1[3]);
    ...
    void check(
        ...
        assertEquals(meters, position.distanceMeters, kDelta);
        assertEquals(degrees, position.angle.getDegrees(), kDelta);
    }
