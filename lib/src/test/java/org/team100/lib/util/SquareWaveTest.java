...
class SquareWaveTest {
    ...
    void testUnitAmplitudeAndPeriod() {
        ...
        assertEquals(1.0, w.applyAsDouble(0.000), kDelta);
        ...
        assertEquals(1.0, w.applyAsDouble(1.000), kDelta);
    ...
    void testAmplitude() {
        ...
        double period = 1;
        SquareWave w = new SquareWave(amplitude, period);
        assertEquals(2.0, w.applyAsDouble(0.000), kDelta);
        assertEquals(2.0, w.applyAsDouble(0.125), kDelta);
        assertEquals(-2.0, w.applyAsDouble(0.250), kDelta);
        assertEquals(-2.0, w.applyAsDouble(0.375), kDelta);
        assertEquals(-2.0, w.applyAsDouble(0.500), kDelta);
        assertEquals(-2.0, w.applyAsDouble(0.625), kDelta);
        assertEquals(2.0, w.applyAsDouble(0.750), kDelta);
        assertEquals(2.0, w.applyAsDouble(0.875), kDelta);
        assertEquals(2.0, w.applyAsDouble(1.000), kDelta);
    }
    ...
    void testPeriod() {
        ...
        assertEquals(-1.0, w.applyAsDouble(0.750), kDelta);
        assertEquals(-1.0, w.applyAsDouble(1.000), kDelta);
        assertEquals(-1.0, w.applyAsDouble(1.250), kDelta);
        assertEquals(1.0, w.applyAsDouble(1.500), kDelta);
        assertEquals(1.0, w.applyAsDouble(1.750), kDelta);
        assertEquals(1.0, w.applyAsDouble(2.000), kDelta);
    }
