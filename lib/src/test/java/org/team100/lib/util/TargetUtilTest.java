...
class TargetUtilTest {
    ...
    void testTargetMotion() {
        ...
        SwerveState state = new SwerveState(new Pose2d(), new Twist2d(1, 0, 0));
    ...
    void testTargetMotionFaster() {
        ...
        SwerveState state = new SwerveState(new Pose2d(), new Twist2d(2, 0, 0));
        // target is 1m to the left
        Translation2d target = new Translation2d(0, 1);
        // so it appears to move clockwise
    ...
    void testTargetMotionElsewhere() {
        ...
        SwerveState state = new SwerveState(new Pose2d(1, 1, new Rotation2d()), new Twist2d(1, 0, 0));
        // target is 1m to the left
    ...
    void testTargetMotionY() {
        ...
        SwerveState state = new SwerveState(new Pose2d(), new Twist2d(0, 1, 0));
        // target is dead ahead
    ...
    void testTargetMotionYReversed() {
        ...
        SwerveState state = new SwerveState(new Pose2d(1, 0, GeometryUtil.kRotation180), new Twist2d(0, 1, 0));
        // target is dead ahead
