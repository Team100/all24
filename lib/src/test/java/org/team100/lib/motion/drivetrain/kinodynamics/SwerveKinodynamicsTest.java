...
class SwerveKinodynamicsTest {
    ...
    void testComputedValues() {
        ...
        double driveV = 1;
        SwerveKinodynamics k = new SwerveKinodynamics(driveV, 1, 1, 1, track, wheelbase, 1);
    ...
    void testComputedAngularAcceleration() {
        ...
        double wheelbase = 0.5;
        double driveA = 1;
        SwerveKinodynamics k = new SwerveKinodynamics(1, driveA, 1, 1, track, wheelbase, 1);
    ...
    void testComputedCapsize() {
        ...
        double wheelbase = 1;
        double vcg = 0.3;
        SwerveKinodynamics k = new SwerveKinodynamics(1, 1, 1, 1, track, wheelbase, vcg);
        assertEquals(1, k.getMaxDriveAccelerationM_S2(), kDelta);
