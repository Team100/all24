...
/**
 * This is a copy of the WPILib TrapezoidProfile, with two changes. First, the
 * deprecated API is removed. Second, the acceleration is exposed, so that
 * feedforward controllers can use it.
 */
public class TrapezoidProfile100 {
  ...
  public TrapezoidProfile100(Constraints constraints, State goal, State initial) {
   ...
   */
  @Deprecated(since = "2024", forRemoval = true)
  public TrapezoidProfile100(Constraints constraints, State goal) {
