...
public class ParameterFactory {
     ...
     */
    public Parameter mutable(String key, double defaultValue) {
     ...
     * Tables.
     */
    public Parameter constant(String key, double value) {
        return m_parameters.computeIfAbsent(key, k -> new ConstantParameter(k, value));
    }

    ////////////////////////////////////////////

    private Parameter make(String key, double defaultValue) {
