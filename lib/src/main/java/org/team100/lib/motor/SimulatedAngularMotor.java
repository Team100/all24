 ...
 */
public class SimulatedAngularMotor
        implements DutyCycleMotor100, VelocityMotor100<Angle100>, GenericTorqueModel {

    private final Logger m_logger;
    private final double m_freeSpeed;
    private double m_velocity = 0;

    public SimulatedAngularMotor(Logger parent, double freeSpeed) {
