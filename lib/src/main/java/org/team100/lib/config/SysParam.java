...
public record SysParam(
    ...
    public static SysParam limitedNeoVelocityServoSystem(double gearRatio, double wheelDiameter, double maxVel, double maxAccel, double maxDecel) {
    ...
    public static SysParam neoPositionServoSystem(double gearRatio, double wheelDiameter, double maxVel, double maxAccel) {
