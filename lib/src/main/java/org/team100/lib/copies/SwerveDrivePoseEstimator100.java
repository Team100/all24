...
/**
 * This class wraps {@link SwerveDriveOdometry Swerve Drive Odometry} to fuse
 * latency-compensated
 ...
 *
 * <p>
 * {@link SwerveDrivePoseEstimator#addVisionMeasurement} can be called as
 * infrequently as you
 * want; if you never call it, then this class will behave as regular encoder
 * odometry.
 */
public class SwerveDrivePoseEstimator100 extends PoseEstimator100<SwerveDriveWheelPositions> {
    ...
    public SwerveDrivePoseEstimator100(
        ...
        super(
                kinematics,
                new SwerveDriveOdometry100(kinematics, gyroAngle, modulePositions, initialPoseMeters),
                stateStdDevs,
