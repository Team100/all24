...
public final class TrajectoryGenerator100 {
    ...
    /**
     * Generates a trajectory from the given control vectors and config. This method
     * uses clamped
     * cubic splines -- a method in which the exterior control vectors and interior
     * waypoints are
     * provided. The headings are automatically determined at the interior points to
     * ensure continuous
     * curvature.
     *
     ...
     * clamped cubic
     * splines -- a method in which the initial pose, final pose, and interior
     * waypoints are provided.
     * The headings are automatically determined at the interior points to ensure
     * continuous
     * curvature.
     *
     ...
     */
    public static Trajectory generateTrajectory(
            Pose2d start, List<Translation2d> interiorWaypoints,
            Pose2d end, TrajectoryConfig100 config) {
     ...
     */
    public static Trajectory generateTrajectory(
            ControlVectorList controlVectors, TrajectoryConfig100 config) {
        final var flip = new Transform2d(new Translation2d(), Rotation2d.fromDegrees(180.0));
