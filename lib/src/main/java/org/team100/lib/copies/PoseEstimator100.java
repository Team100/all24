 ...
 */
public class PoseEstimator100<T extends WheelPositions<T>> {
    private final Kinematics<?, T> m_kinematics;
    private final Odometry100<T> m_odometry;
     ...
     */
    public PoseEstimator100(
            Kinematics<?, T> kinematics,
            Odometry100<T> odometry,
     ...
     *                              PoseEstimator#updateWithTime(double,Rotation2d,WheelPositions)}
     *                              then you must use a
    ...
    private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof PoseEstimator100.InterpolationRecord)) {
                return false;
            }
            var record = (PoseEstimator100<?>.InterpolationRecord) obj;
