...
public class TrajectoryConfig100 {
  ...
  public TrajectoryConfig100(
    ...
    this(maxVelocity.in(Units.MetersPerSecond), maxAcceleration.in(Units.MetersPerSecondPerSecond));
  }
   ...
   */
  public TrajectoryConfig100 addConstraint(TrajectoryConstraint constraint) {
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 addConstraints(List<? extends TrajectoryConstraint> constraints) {
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setKinematics(DifferentialDriveKinematics kinematics) {
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setKinematics(MecanumDriveKinematics kinematics) {
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setKinematics(SwerveDriveKinematics100 kinematics) {
    addConstraint(new SwerveDriveKinematicsConstraint100(kinematics, m_maxVelocity));
    return this;
  }
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setStartVelocity(double startVelocityMetersPerSecond) {
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setStartVelocity(Measure<Velocity<Distance>> startVelocity) {
    return setStartVelocity(startVelocity.in(Units.MetersPerSecond));
  }
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setEndVelocity(double endVelocityMetersPerSecond) {
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setEndVelocity(Measure<Velocity<Distance>> endVelocity) {
    return setEndVelocity(endVelocity.in(Units.MetersPerSecond));
  }
   ...
   * @return Instance of the current config object.
   */
  public TrajectoryConfig100 setReversed(boolean reversed) {
    m_reversed = reversed;
    return this;
  }
}
