...
public class ManualFieldRelativeSpeeds implements FieldRelativeDriver {
    ...
    public FieldRelativeVelocity apply(SwerveState state, DriverControl.Velocity input) {
        ...
        t.log(Level.TRACE, m_name, "twist x m_s", twistM_S.x());
        t.log(Level.TRACE, m_name, "twist y m_s", twistM_S.y());
        t.log(Level.TRACE, m_name, "twist theta rad_s", twistM_S.theta());
        return twistM_S;
    }
