        ...
        switch (Identity.instance) {
            case COMP_BOT:
                ...
                return new SwerveModuleCollection(
                        WCPSwerveModule100.get(
                                ...
                                AnalogTurningEncoder.class, 30, 0, 0.708328, kinodynamics, Drive.DIRECT),
                        WCPSwerveModule100.get(
                                kFrontRight, currentLimit, 12,
                                AnalogTurningEncoder.class, 32, 1, 0.659267, kinodynamics, Drive.DIRECT),
                        WCPSwerveModule100.get(
                                kRearLeft, currentLimit, 21,
                                AnalogTurningEncoder.class, 31, 2, 0.396148, kinodynamics, Drive.DIRECT),
                        WCPSwerveModule100.get(
                                kRearRight, currentLimit, 22,
                                AnalogTurningEncoder.class, 33, 3, 0.109823, kinodynamics, Drive.DIRECT));
            case SWERVE_TWO:
            ...
            case BETA_BOT:
                ...
                return new SwerveModuleCollection(
                       WCPSwerveModule100.get(
                                kFrontLeft, currentLimit, 3,
                                DutyCycleTurningEncoder.class, 34, 2, 0.789769, kinodynamics, Drive.INVERSE), //1
                        WCPSwerveModule100.get(
                                kFrontRight, currentLimit, 22,
                                DutyCycleTurningEncoder.class, 25, 1, 0.057031, kinodynamics, Drive.INVERSE), //0
                        WCPSwerveModule100.get(
                                kRearLeft, currentLimit, 13,
                                DutyCycleTurningEncoder.class, 12, 3, 0.143337, kinodynamics, Drive.INVERSE),
                        WCPSwerveModule100.get(
                                kRearRight, currentLimit, 11,
                                DutyCycleTurningEncoder.class, 21, 0, 0.255889, kinodynamics, Drive.INVERSE));
            default:
