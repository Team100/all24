...
/**
 * Select one of two position servo implementations.
 * 
 * This allows the servo to be selected at runtime.
 */
public class SelectablePositionServo<T extends Measure100> implements PositionServo<T> {

    private final PositionServo<T> m_whenTrue;
    private final PositionServo<T> m_whenFalse;
    private final BooleanSupplier m_selector;

    public SelectablePositionServo(
            PositionServo<T> whenTrue,
            PositionServo<T> whenFalse,
