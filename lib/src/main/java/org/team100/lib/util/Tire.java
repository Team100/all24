...
public class Tire {
    ...
    public Vector2d actual(Vector2d cornerM_s, Vector2d wheelM_s, double dtS) {
        m_logger.logVector2d(Level.WARN, "corner M_s", () -> cornerM_s);
        m_logger.logVector2d(Level.WARN, "wheel M_s", () -> wheelM_s);
        ...
        m_logger.logVector2d(Level.INFO, "desired accel M_s_s", () -> desiredAccelM_s_s);
        ...
        m_logger.logVector2d(Level.INFO, "limited accel M_s_s", () -> limitedAccelM_s_s);

        // Vector2d actual = apply(cornerM_s, desiredAccelM_s_s, dtS);
        Vector2d actual = apply(cornerM_s, limitedAccelM_s_s, dtS);
        m_logger.logVector2d(Level.WARN, "actual M_s", () -> actual);
        return actual;
    }
    ...
    Vector2d limit(Vector2d scaledAccelM_s_s) {
        ...
        if (normM_s_s <= saturationM_s_s) {
            m_logger.logVector2d(Level.DEBUG, "limit M_s_s", () -> scaledAccelM_s_s);
            return scaledAccelM_s_s;
        }
        Vector2d limitedM_s_s = scaledAccelM_s_s.times(saturationM_s_s / normM_s_s);
        m_logger.logVector2d(Level.DEBUG, "limit M_s_s", () -> limitedM_s_s);
        return limitedM_s_s;
    }
}
