...
public class RobotContainer {
  ...
  private final OutboardAngularPositionServo m_motor2;
    ...
    public RobotContainer(TimedRobot100 robot) throws IOException {
        ...
        final Falcon6Motor falconMotor1 = new Falcon6Motor(fieldLogger, 0, MotorPhase.FORWARD, 5, 5, new PIDConstants(0.1), Feedforward100.makeShooterFalcon6());
        final Falcon6Motor falconMotor2 = new Falcon6Motor(fieldLogger, 0, MotorPhase.FORWARD, 5, 5, new PIDConstants(0.1), Feedforward100.makeShooterFalcon6());

        final RotaryMechanism rotaryMechanism1 = new RotaryMechanism(fieldLogger, falconMotor1, new Talon6Encoder(fieldLogger, falconMotor1), 1);
        final RotaryMechanism rotaryMechanism2 = new RotaryMechanism(fieldLogger, falconMotor2, new Talon6Encoder(fieldLogger, falconMotor2), 1);

        final CombinedEncoder combinedEncoder1 = new CombinedEncoder(fieldLogger, new ProxyRotaryPositionSensor(rotaryMechanism1), rotaryMechanism1);
        final CombinedEncoder combinedEncoder2 = new CombinedEncoder(fieldLogger, new ProxyRotaryPositionSensor(rotaryMechanism2), rotaryMechanism2);
  ...
  public void teleopPeriodic(){
    m_motor1.setPosition(Math.PI, 0);
    m_motor2.setPosition(Math.PI, 0);
  }
}
