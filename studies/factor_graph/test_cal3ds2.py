...
from numerical_derivative import numericalDerivative21Point2Cal3DS2Point2
from numerical_derivative import numericalDerivative22Point2Cal3DS2Point2
...
class TestCal3DS2(unittest.TestCase):
    ...
    def test_Duncalibrate1(self) -> None:
        ...
        numerical = numericalDerivative21Point2Cal3DS2Point2(uncalibrate_, K, p, 1e-7)
    ...
    def test_Duncalibrate2(self) -> None:
        ...
        numerical = numericalDerivative22Point2Cal3DS2Point2(uncalibrate_, K, p, 1e-7)
        assert_almost_equal(numerical, computed, 5)
    ...
    def test_Dcalibrate(self) -> None:
        ...
        numerical1 = numericalDerivative21Point2Cal3DS2Point2(calibrate_, K, pi, 1e-7)
        assert_almost_equal(numerical1, Dcal, 5)
        numerical2 = numericalDerivative22Point2Cal3DS2Point2(calibrate_, K, pi, 1e-7)
