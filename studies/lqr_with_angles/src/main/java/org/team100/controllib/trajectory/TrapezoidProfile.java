package org.team100.controllib.trajectory;
...
/**
 * This is cut-and-paste from WPI because accel is not exposed there.
 */
public class TrapezoidProfile {
    ...
    public State calculate(double t) {
        ...
        if (t < m_endAccel) {
            ...
            result.acceleration = -1.0 * m_constraints.maxAcceleration;
        } else {
            result = m_goal;
        }
