...
class RBFInterpolatingFunctionTest {
    ...
    //                 VecBuilder.fill(1, 0));
    //         double[][] phi = RBFInterpolatingFunction.phi(x, identity);
    ...
    //         List<Vector<N2>> x = List.of(
    //                 VecBuilder.fill(1, 0));
    //         double[][] phi = RBFInterpolatingFunction.phi(x, RBFInterpolatingFunction.GAUSSIAN);
    //         // matrix size is equal to the number of points
    //         assertEquals(1, phi.length);
    //         assertEquals(1, phi[0].length);
    ...
    //     double[] phiVec = RBFInterpolatingFunction.phiVec(p, x, r -> r);
    ...
    //         double r = RBFInterpolatingFunction.r(a, b);
    ...
    //     RBFInterpolatingFunction<N1, N1> interp = new RBFInterpolatingFunction<>(
    //             RBFInterpolatingFunction.GAUSSIAN, Nat.N1());
    ...
    //     double[] phiVec = RBFInterpolatingFunction.phiVec(p, interp.m_x, interp.m_rbf);
    ...
    //     RBFInterpolatingFunction<N2, N2> interp = new RBFInterpolatingFunction<>(
    //             RBFInterpolatingFunction.GAUSSIAN, Nat.N2());
    //     interp.put(x.get(0), y.get(0));
    //     interp.calculateWeights();
    ...
    // @Test
    // void testSimple() {
    //     RBFInterpolatingFunction<N3, N2> interp = new RBFInterpolatingFunction<>(
    //             RBFInterpolatingFunction.GAUSSIAN, Nat.N2());
    ...
    //     RBFInterpolatingFunction<N2, N1> interp = new RBFInterpolatingFunction<>(
    //             RBFInterpolatingFunction.GAUSSIAN, Nat.N1());
    ...
    //         RBFInterpolatingFunction<N2, N1> interp, double px0, double px1) {
