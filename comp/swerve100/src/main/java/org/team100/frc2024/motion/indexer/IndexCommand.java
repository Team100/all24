...
public class IndexCommand extends Command100 {
  ...
  public void execute100(double dt) {
    //TODO Get the real value here, should just take a few seconds, put the amp arm to the correct pos and get the value from glass in rots
    double ampMidPos = 1;
    if (m_amp.getLeftAmpPosition()>ampMidPos|| (m_shooter.getFirstRollerVelocity()>m_desiredShooterVelocity && m_shooter.getSecondRollerVelocity()>m_desiredShooterVelocity)) {
