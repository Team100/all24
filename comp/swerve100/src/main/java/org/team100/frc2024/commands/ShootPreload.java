...
public class ShootPreload extends Command implements Glassy {
    ...
    public void initialize() {
        ...
        logger.logString(Level.DEBUG, "command state", () -> "initialize");
    ...
    @Override
    public void execute() {
        logger.logString(Level.DEBUG, "command state", () -> "end");
        logger.logInt(Level.DEBUG, "END", () -> 0);
        Optional<Alliance> alliance = DriverStation.getAlliance();
        if (!alliance.isPresent())
            return;
    ...
    public void end(boolean interrupted) {
        logger.logString(Level.DEBUG, "command state", () -> "end");
        logger.logString(Level.DEBUG, "command state", () -> "end");
        logger.logInt(Level.DEBUG, "END", () -> 1);
        atVelocity = false;
        finished = false;
        m_timer.stop();
        m_shooter.stop();
