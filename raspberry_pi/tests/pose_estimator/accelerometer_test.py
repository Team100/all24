...
class AccelerometerTest(unittest.TestCase):
    ...
    def test_h_1(self) -> None:
        """Verify h alone, constant velocity"""
    ...
    def test_h_1a(self) -> None:
        """Verify h alone, constant angular velocity"""
        p0 = gtsam.Pose2(0, 0, 0)
    ...
    def test_h_2(self) -> None:
        """Verify h alone, linear acceleration"""
        p0 = gtsam.Pose2(0, 0, 0)
        p1 = gtsam.Pose2(1, 0, 0)
    ...
    def test_h_2a(self) -> None:
        """Verify h alone, angular acceleration"""
        p0 = gtsam.Pose2(0, 0, 0)
        p1 = gtsam.Pose2(0, 0, 1)
        ...
        self.assertAlmostEqual(0, result[0])
        self.assertAlmostEqual(0, result[1])
        self.assertAlmostEqual(5000, result[2])

    def test_h_coriolis(self) -> None:
        """Verify h alone, constant linear and angular speed"""
        p0 = gtsam.Pose2(0, 0, 0)
    ...
    def test_H(self) -> None:
        ...
        dt1 = 0.02
        dt2 = 0.02
        measured = np.array([0, 0, 0])
        H = [np.zeros((3, 3)), np.zeros((3, 3)), np.zeros((3, 3))]
